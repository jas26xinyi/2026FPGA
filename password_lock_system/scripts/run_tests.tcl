...
open_project [file join $project_root vivado password_lock_system.xpr]
add_files -fileset sim_1 -norecurse [glob -directory [file join $project_root sim] *.sv]
set_property file_type SystemVerilog [get_files -of_objects [get_filesets sim_1] *.sv]
set tests {tb_lock_controller tb_keypad_scanner tb_frame_capture tb_mosaic_renderer tb_flash_default_fail tb_flash_journal}
