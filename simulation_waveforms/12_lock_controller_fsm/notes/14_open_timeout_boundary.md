# 14_open_timeout_boundary：开锁 2000 拍自动关锁（期限放大）

窗口：**54495–54660 ns**，连续绝对时间；scenario=14。

## 原生 Vivado 截屏

![原生 Vivado 分段波形](../images/14_open_timeout_boundary_native.png)
...
配置：[WCFG](../configs/14_open_timeout_boundary.wcfg)，完整数据：[WDB](../tb_lock_controller_fsm.wdb)、[VCD](../tb_lock_controller_fsm.vcd)。
...
open_wave_config E:/26FPGA/simulation_waveforms/12_lock_controller_fsm/configs/14_open_timeout_boundary.wcfg
