# 15_open_deadline_priority_boundary：OPEN 优先级：超时与 A 关锁均优先于 KEY1（期限放大）

窗口：**74685–74875 ns**，连续绝对时间；scenario=15。

## 原生 Vivado 截屏

![原生 Vivado 分段波形](../images/15_open_deadline_priority_boundary_native.png)
...
配置：[WCFG](../configs/15_open_deadline_priority_boundary.wcfg)，完整数据：[WDB](../tb_lock_controller_fsm.wdb)、[VCD](../tb_lock_controller_fsm.vcd)。
...
open_wave_config E:/26FPGA/simulation_waveforms/12_lock_controller_fsm/configs/15_open_deadline_priority_boundary.wcfg
