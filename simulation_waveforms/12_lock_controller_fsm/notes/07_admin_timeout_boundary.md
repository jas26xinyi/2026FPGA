# 07_admin_timeout_boundary：管理员输入超时不写 Flash（期限放大）

窗口：**31375–31540 ns**，连续绝对时间；scenario=7。

## 原生 Vivado 截屏

![原生 Vivado 分段波形](../images/07_admin_timeout_boundary_native.png)
...
配置：[WCFG](../configs/07_admin_timeout_boundary.wcfg)，完整数据：[WDB](../tb_lock_controller_fsm.wdb)、[VCD](../tb_lock_controller_fsm.vcd)。
...
open_wave_config E:/26FPGA/simulation_waveforms/12_lock_controller_fsm/configs/07_admin_timeout_boundary.wcfg
