# 20_temp_timeout_boundary：TEMP 显示超时退出（期限放大）

窗口：**85655–85820 ns**，连续绝对时间；scenario=20。

## 原生 Vivado 截屏

![原生 Vivado 分段波形](../images/20_temp_timeout_boundary_native.png)
...
配置：[WCFG](../configs/20_temp_timeout_boundary.wcfg)，完整数据：[WDB](../tb_lock_controller_fsm.wdb)、[VCD](../tb_lock_controller_fsm.vcd)。
...
open_wave_config E:/26FPGA/simulation_waveforms/12_lock_controller_fsm/configs/20_temp_timeout_boundary.wcfg
